            ...
            <div className="relative w-full h-full">
                ...
                <div className="flex justify-between border-b border-white/20 items-center px-5 py-4">
                    <div className="flex items-center">
                        <p className=" font-extrabold ml-1 text-2xl">Gibrabot</p>
                    </div>
...
const Header = ({ $, NavItems }) => {
    ...
    useEffect(() => {
        ...
        if (theme === "bleu") setHue("hue-rotate-[180deg]");
        if (theme === "vert") setHue("hue-rotate-[70deg]");
        if (theme === "rose") setHue("hue-rotate-[330deg]");
        if (theme === "orange") setHue("");
    }, []);
                    ...
                    <div className="flex items-center space-x-6">
                        <div className="flex items-center space-x-3">
                            <p className="invisible md:visible text-xl text-white font-semibold">
                              <a href="/"><span className="text-amber-400">Gibra</span>bot</a>
                            </p>
                        </div>
